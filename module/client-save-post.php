  ...
  <div class="row justify-content-center">
    ...
    <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 ">
      <div class="card table-responsive">
          <h3 class="card-header">Save post's list</h3>
          <div class="card-body">
              <table class="table table-bordered table-hover" id="post_data">
                  ...
                  <tbody>
                      <?php 
                        $sqlselectPost = "SELECT * FROM tbl_blog INNER JOIN tbl_post_save ON tbl_blog.post_id = tbl_post_save.post_id WHERE tbl_post_save.save_status = 1 AND tbl_post_save.client_id =".$_SESSION["client_id"];
                       ...
                       ?>
                          <tr class="table-body">
                              ...
                              <td><?php echo $rowComment["total_comment"] ?>
                                  <button class="btn btn-sm btn-outline-success" style="background-color: black; font-size: 12px"><a href="post.php?module=post-detail&id=<?php echo $row["post_id"] ?>#form-cmt" style="color: white; text-decoration: none"><i class="fas fa-edit"></i></a></button>
                              </td>
                              <td><?php echo $row["createdate"] ?></td>
                              <td><a href="post.php?module=post-detail&id=<?php echo $row["post_id"] ?>"><i class="fas fa-edit"></i></a></d></td>
                          </tr>
                  <?php } ?>
                  </tbody>
              </table>
